...
@Stateless
@WebService(serviceName="Greeter", endpointInterface="org.njp.ejb.CreditCardValidatorRemote")
public class CreditCardValidator implements CreditCardValidatorRemote {
	...
	static public boolean isValidFormat(String number) {
		try {
	...
	static public boolean isPrefix(String number, int[] valid_nums) {
